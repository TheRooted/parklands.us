...
router.post(path.resolve(__dirname, '/signup'), passport.authenticate('local-signup', { successRedirect: '/mapview', failureRedirect: '/signup', failureFlash: true }));
router.post(path.resolve(__dirname, '/signin'), passport.authenticate('local-signin', { successRedirect: '/mapview', failureRedirect: '/signin', failureFlash: true }));
