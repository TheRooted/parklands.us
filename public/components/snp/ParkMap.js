...
export default class ParkMap extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.park.long && nextProps.park.long !== this.state.long) {
      var name = '';
  ...
  render() {
    return (
      <div id="map" style={{width:'220px', height:'220px', float:'left', marginTop:'10px',marginRight:'14px', marginBottom:'5px', borderRadius:'5px'}}></div>
    )
  }
}
